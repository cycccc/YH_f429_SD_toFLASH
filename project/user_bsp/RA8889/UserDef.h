...
#define AT070TN92		//##INNOLUX_800x480  群创
...
//	#define BA104S01_100	//BOE_800x600(京東方)// 18bpp LVDS

//	#define LCD_1280x800	//for test

//	#define LCD_1366x768	//for test

//#define USER_LCD_800x480  // 自定义的屏幕参数尺寸  800x480 型号: WS050TN02-40NM01
